...
def gobuster_cmd(t: str, d: pathlib.Path):
    # -b 403 → игнорировать wildcard 403, '-r' не следовать редиректам
    return [
...
"gobuster", "dir", "-q", "-u", f"http://{t}", "-w", "/opt/wordlists/SecLists/Discovery/Web-Content/big.txt", "-o", str(d / "gob_80.txt")]
